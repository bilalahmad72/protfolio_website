...
export const journeyChapters: JourneyChapter[] = [
  {
    ...
    summary:
      'Freelancing on Upwork and Fiverr while studying, then Avunja, Gymscanner and three production apps at Whooo — Figma to Flutter, Firebase, and my first releases on both stores.',
    body: [
      ...
      'Gymscanner, later that year, was where the UI itself was the hard part: a glassmorphism interface built as reusable blurred widgets rather than one-off decorations, responsive across phone sizes, with GetX and MVC underneath and Firebase Auth and Cloud Firestore behind it.',
