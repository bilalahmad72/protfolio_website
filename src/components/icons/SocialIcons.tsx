...
/*
 * Upwork and Fiverr ship as wordmark/glyph PNGs rather than icon fonts, so the
 * brand paths are inlined here. Both are solid-fill marks — unlike the stroked
 * icons above — but they take `currentColor` all the same, which is what lets
 * them sit in the same row and inherit the same hover colour.
 */
