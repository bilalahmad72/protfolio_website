      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-accent tracking-wider">
              Bilal Ahmad
            </h3>
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h4 className="text-sm font-semibold text-slate-800 uppercase tracking-wider">Contact Info</h4>
            <ul className="space-y-3 text-sm text-slate-600">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:bilalahmad72.official@gmail.com" className="hover:text-accent transition-colors break-all">
